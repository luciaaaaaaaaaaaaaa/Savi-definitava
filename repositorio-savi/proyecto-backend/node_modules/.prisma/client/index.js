...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\lucia\\OneDrive\\Documentos\\GitHub\\Savi-definitava\\repositorio-savi\\proyecto-backend\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\lucia\\OneDrive\\Documentos\\GitHub\\Savi-definitava\\repositorio-savi\\proyecto-backend\\prisma\\schema.prisma"
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
    "schemaEnvPath": "../../../.env"
  ...
  "inlineSchema": "// Este archivo define el esquema de la base de datos para Prisma\n// Ejecuta: npx prisma migrate dev --name init para crear la base de datos\n\ngenerator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  name      String\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Contact {\n  id        Int      @id @default(autoincrement())\n  name      String\n  email     String\n  message   String\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "13639c3f774997d2bb753dc5086bfbb40511b709797eeb4d23203aca5219efe0",
  "copyEngine": true
}
